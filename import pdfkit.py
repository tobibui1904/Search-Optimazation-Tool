...
""")
    st.markdown("""- Step 1: If you have your own PDF files, upload it to the program. Otherwise, if you want to search for something online, paste the link to the input bar. """)
    st.markdown("""- Step 2: """)
...
with converter:
    ...
    #otherwise, upload from local 
        ...
        uploaded_file = st.file_uploader('Please choose your .pdf file', type="pdf", accept_multiple_files= True)
